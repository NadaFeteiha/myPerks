...
def _patches(
    *,
    ...
    async def _fake_resolve(_clerk_user_id, _session):
        return _employee
...
class TestUploadCallback:
    ...
    def test_duplicate_pdf_returns_existing_document_id(self):
    ...
    def test_empty_files_list_returns_422(self):
    ...
    def test_employee_not_found_returns_403(self):
    ...
    def test_cdn_error_returns_502(self):
    ...
    def test_non_pdf_content_type_returns_422(self):
    ...
    def test_ingestion_failure_returns_500(self):
